...
typedef enum foePositionBinaryResult {
    ...
    FOE_POSITION_BINARY_DATA_NOT_EXPORTED = 1,
    FOE_POSITION_BINARY_ERROR_OUT_OF_MEMORY = -1,
    FOE_POSITION_BINARY_ERROR_FAILED_TO_REGISTER_3D_IMPORTER = -2,
    FOE_POSITION_BINARY_ERROR_FAILED_TO_REGISTER_3D_EXPORTER = -3,
    FOE_POSITION_BINARY_ERROR_POSITION_3D_POOL_NOT_FOUND = -4,
