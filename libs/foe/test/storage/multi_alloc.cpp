...
TEST_CASE("foeMultiAllocStorage Constructor") {
    SECTION("Default constructors have zero capacity, and all pointers are null") {
        SECTION("Single Template Argument") {
            ...
            SECTION("double") {
                foeMultiAllocStorage<double> test;
            ...
            SECTION("std::string") {
                foeMultiAllocStorage<std::string> test;
            ...
            SECTION("std::optional<std::string>") {
                foeMultiAllocStorage<std::optional<std::string>> test;
            ...
            SECTION("std::variant<int, double, std::string>") {
                foeMultiAllocStorage<std::variant<int, double, std::string>> test;
        ...
        SECTION("Multi Template Argument") {
            SECTION("int, int, double") {
                foeMultiAllocStorage<int, int, double> test;
    ...
    SECTION("Constructors with a non-zero value have allocated pointers") {
        SECTION("Single Template Argument") {
            SECTION("int") {
                foeMultiAllocStorage<int> test{1};
            ...
            SECTION("double") {
                foeMultiAllocStorage<double> test{1};
            ...
            SECTION("std::string") {
                foeMultiAllocStorage<std::string> test{1};
            ...
            SECTION("std::optional<std::string>") {
                foeMultiAllocStorage<std::optional<std::string>> test{1};
            ...
            SECTION("std::variant<int, double, std::string>") {
                foeMultiAllocStorage<std::variant<int, double, std::string>> test{1};
        ...
        SECTION("Multi Template Argument") {
            SECTION("int, int, double") {
                foeMultiAllocStorage<int, int, double> test{1};
...
TEST_CASE("foeMultiAllocStorage Move Constructor") {
    SECTION("Single Template Argument") {
        SECTION("int") {
            foeMultiAllocStorage<int> test{1};
            auto ptr0 = test.get<0>();
            foeMultiAllocStorage<int> moveTo{std::move(test)};
        ...
        SECTION("double") {
            foeMultiAllocStorage<double> test{1};
            auto ptr0 = test.get<0>();
            foeMultiAllocStorage<double> moveTo{std::move(test)};
        ...
        SECTION("std::string") {
            foeMultiAllocStorage<std::string> test{1};
            auto ptr0 = test.get<0>();
            foeMultiAllocStorage<std::string> moveTo{std::move(test)};
        ...
        SECTION("std::optional<std::string>") {
            foeMultiAllocStorage<std::optional<std::string>> test{1};
            auto ptr0 = test.get<0>();
            foeMultiAllocStorage<std::optional<std::string>> moveTo{std::move(test)};
        ...
        SECTION("std::variant<int, double, std::string>") {
            foeMultiAllocStorage<std::variant<int, double, std::string>> test{1};
            auto ptr0 = test.get<0>();
            foeMultiAllocStorage<std::variant<int, double, std::string>> moveTo{std::move(test)};
    ...
    SECTION("Multi Template Argument") {
        SECTION("int, int, double") {
            ...
            foeMultiAllocStorage<int, int, double> moveTo{std::move(test)};
...
TEST_CASE("foeMultiAllocStorage Move Operator") {
    SECTION("Single Template Argument") {
        SECTION("int") {
            foeMultiAllocStorage<int> test{1};
            auto ptr0 = test.get<0>();
