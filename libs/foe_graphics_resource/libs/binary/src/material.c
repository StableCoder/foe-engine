...
foeResultSet export_foeMaterialCreateInfo(foeResourceCreateInfo createInfo,
    ...
    if (ciType == FOE_GRAPHICS_RESOURCE_STRUCTURE_TYPE_MATERIAL_CREATE_INFO) {
        result = binary_write_foeMaterialCreateInfo(foeResourceCreateInfoGetData(createInfo),
                                                    &set.dataSize, NULL);
        ...
        set.pKey = binary_key_foeMaterialCreateInfo();
    }
