...
FOE_GFX_RES_BINARY_EXPORT foeResultSet foeGraphicsResourceBinaryRegisterImporters();

FOE_GFX_RES_BINARY_EXPORT void foeGraphicsResourceBinaryDeregisterImporters();
