...
std::string foeGraphicsResourceYamlErrorCategory::message(int ev) const {
    switch (static_cast<foeGraphicsResourceYamlResult>(ev)) {
        ...
        RESULT_CASE(FOE_GRAPHICS_RESOURCE_YAML_ERROR_FAILED_TO_REGISTER_IMAGE_EXPORTER)
        // Material Resource
        ...
        RESULT_CASE(FOE_GRAPHICS_RESOURCE_YAML_ERROR_FAILED_TO_REGISTER_MESH_EXPORTER)
        ...
        RESULT_CASE(FOE_GRAPHICS_RESOURCE_YAML_ERROR_FAILED_TO_REGISTER_VERTEX_DESCRIPTOR_EXPORTER)
