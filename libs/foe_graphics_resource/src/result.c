...
void foeGraphicsResourceResultToString(foeGraphicsResourceResult value,
    ...
    switch (value) {
        ...
        RESULT_CASE(FOE_GRAPHICS_RESOURCE_ERROR_OUT_OF_MEMORY)
        ...
        RESULT_CASE(FOE_GRAPHICS_RESOURCE_ERROR_MATERIAL_SUBRESOURCE_INCOMPATIBLE)
        ...
        RESULT_CASE(FOE_GRAPHICS_RESOURCE_ERROR_VERTEX_DESCRIPTOR_SUBRESOURCE_INCOMPATIBLE)
    ...
    default:
        if (value > 0) {
            snprintf(buffer, FOE_MAX_RESULT_STRING_SIZE, "FOE_GRAPHICS_RESOURCE_UNKNOWN_SUCCESS_%i",
                     value);
        } else {
            value = abs(value);
            snprintf(buffer, FOE_MAX_RESULT_STRING_SIZE, "FOE_GRAPHICS_RESOURCE_UNKNOWN_ERROR_%i",
                     value);
        }
    }
