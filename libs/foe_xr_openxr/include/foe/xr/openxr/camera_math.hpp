...
FOE_XR_EXPORT glm::mat4 foeXrProjectionMatrix(XrFovf const &fieldOfView, float nearZ, float farZ);

FOE_XR_EXPORT glm::quat foeXrPoseOrientation(XrPosef const &pose);
