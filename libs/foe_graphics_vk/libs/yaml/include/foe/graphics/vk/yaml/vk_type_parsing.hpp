...
#ifndef FOE_GRAPHICS_VK_YAML_VK_TYPE_PARSING_HPP
#define FOE_GRAPHICS_VK_YAML_VK_TYPE_PARSING_HPP
...
FOE_GFX_VK_YAML_EXPORT void yaml_read_required_vk(std::string const &typeName,
 ...
 */
template <typename VkType>
FOE_GFX_VK_YAML_EXPORT bool yaml_read_optional_vk(std::string const &typeName,
                                                  std::string const &nodeName,
                                                  YAML::Node const &node,
                                                  VkType &data);
 ...
 */
template <typename VkType>
FOE_GFX_VK_YAML_EXPORT void yaml_write_required_vk(std::string const &typeName,
                                                   std::string const &nodeName,
                                                   VkType const &data,
                                                   YAML::Node &node);
