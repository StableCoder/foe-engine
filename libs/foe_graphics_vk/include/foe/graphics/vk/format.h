...
FOE_GFX_EXPORT bool foeGfxVkIsDepthFormat(VkFormat format);

/// Returns if the given format is a depth-stencil compatible format
FOE_GFX_EXPORT bool foeGfxVkIsDepthStencilFormat(VkFormat format);
 ...
 */
FOE_GFX_EXPORT VkDeviceSize foeGfxVkBytesPerPixel(VkFormat format, VkImageAspectFlags aspects);
