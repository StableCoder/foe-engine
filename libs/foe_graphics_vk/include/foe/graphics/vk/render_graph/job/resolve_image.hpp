...
#ifndef FOE_GRAPHICS_RENDER_GRAPH_JOB_RESOLVE_IMAGE_HPP
#define FOE_GRAPHICS_RENDER_GRAPH_JOB_RESOLVE_IMAGE_HPP
...
foeGfxVkResolveImageRenderJob(foeGfxVkRenderGraph renderGraph,
                              char const *pJobName,
                              VkFence fence,
