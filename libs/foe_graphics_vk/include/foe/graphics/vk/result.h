...
typedef enum foeGraphicsVkResult {
    ...
    FOE_GRAPHICS_VK_ERROR_EXTENT_SIZE_INVALID = -100001025,
    FOE_GRAPHICS_VK_ERROR_EXTENT_SIZE_LESS_THAN_SUPPORTED = -100001026,
    FOE_GRAPHICS_VK_ERROR_EXTENT_SIZE_MORE_THAN_SUPPORTED = -100001027,
    FOE_GRAPHICS_VK_ERROR_OUT_OF_POOL_MEMORY = -100001028,
    FOE_GRAPHICS_VK_ERROR_DATA_LARGER_THAN_BUFFER = -100001029,
} foeGraphicsVkResult;
