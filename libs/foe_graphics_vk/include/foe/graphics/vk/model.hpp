...
FOE_GFX_EXPORT foeResultSet mapModelBuffers(VmaAllocator allocator,
...
FOE_GFX_EXPORT foeResultSet recordModelUploadCommands(foeGfxUploadContext uploadContext,
