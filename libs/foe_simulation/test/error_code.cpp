...
TEST_CASE("foeSimulationResult - Ensure error codes return correct values and strings") {
    ...
    ERROR_CODE_CATCH_CHECK(FOE_SIMULATION_ERROR_FUNCTIONALITY_ID_INVALID)
    ERROR_CODE_CATCH_CHECK(FOE_SIMULATION_ERROR_FUNCTIONALITY_ALREADY_REGISTERED)
    ERROR_CODE_CATCH_CHECK(FOE_SIMULATION_ERROR_FUNCTIONALITY_ID_ALREADY_IN_USE)
    ...
    // Simulation Graphics
    ERROR_CODE_CATCH_CHECK(FOE_SIMULATION_ERROR_GRAPHICS_ALREADY_INITIALIZED)
    ERROR_CODE_CATCH_CHECK(FOE_SIMULATION_ERROR_GRAPHICS_NOT_INITIALIZED)
}