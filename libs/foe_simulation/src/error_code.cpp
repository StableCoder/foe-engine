...
std::string foeSimulationErrCategory::message(int ev) const {
    switch (static_cast<foeSimulationResult>(ev)) {
        ...
        RESULT_CASE(FOE_SIMULATION_ERROR_FUNCTIONALITY_ID_INVALID)
        RESULT_CASE(FOE_SIMULATION_ERROR_FUNCTIONALITY_ALREADY_REGISTERED)
        RESULT_CASE(FOE_SIMULATION_ERROR_FUNCTIONALITY_ID_ALREADY_IN_USE)
        ...
        // Simulation Graphics
        RESULT_CASE(FOE_SIMULATION_ERROR_GRAPHICS_ALREADY_INITIALIZED)
        RESULT_CASE(FOE_SIMULATION_ERROR_GRAPHICS_NOT_INITIALIZED)
