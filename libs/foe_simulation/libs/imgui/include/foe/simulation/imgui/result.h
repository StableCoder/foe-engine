...
typedef enum foeSimulationImGuiResult {
    ...
    FOE_SIMULATION_IMGUI_ERROR_ALL_PARAMETERS_NULL = -1,
    FOE_SIMULATION_IMGUI_ERROR_FUNCTIONALITY_ALREADY_REGISTERED = -2,
    FOE_SIMULATION_IMGUI_ERROR_FUNCTIONALITY_NOT_REGISTERED = -3,
