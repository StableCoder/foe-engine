...
enum foeSimulationResult {
    ...
    FOE_SIMULATION_ERROR_FUNCTIONALITY_ID_INVALID,
    FOE_SIMULATION_ERROR_FUNCTIONALITY_ALREADY_REGISTERED,
    FOE_SIMULATION_ERROR_FUNCTIONALITY_ID_ALREADY_IN_USE,
    FOE_SIMULATION_ERROR_FUNCTIONALITY_NOT_REGISTERED,
    FOE_SIMULATION_ERROR_SIMULATION_NOT_REGISTERED,
    FOE_SIMULATION_ERROR_ALREADY_INITIALIZED,
    FOE_SIMULATION_ERROR_NOT_INITIALIZED,
    // Simulation Graphics
    FOE_SIMULATION_ERROR_GRAPHICS_ALREADY_INITIALIZED,
    FOE_SIMULATION_ERROR_GRAPHICS_NOT_INITIALIZED,
};
