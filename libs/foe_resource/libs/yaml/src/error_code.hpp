...
enum foeResourceYamlResult {
    ...
    FOE_RESOURCE_YAML_ERROR_FAILED_TO_REGISTER_ARMATURE_IMPORTER,
    FOE_RESOURCE_YAML_ERROR_FAILED_TO_REGISTER_MESH_IMPORTER,
    FOE_RESOURCE_YAML_ERROR_FAILED_TO_REGISTER_MATERIAL_IMPORTER,
    FOE_RESOURCE_YAML_ERROR_FAILED_TO_REGISTER_VERTEX_DESCRIPTOR_IMPORTER,
    FOE_RESOURCE_YAML_ERROR_FAILED_TO_REGISTER_SHADER_IMPORTER,
    FOE_RESOURCE_YAML_ERROR_FAILED_TO_REGISTER_IMAGE_IMPORTER,
    FOE_RESOURCE_YAML_ERROR_FAILED_TO_REGISTER_RESOURCE_EXPORTERS,
};
