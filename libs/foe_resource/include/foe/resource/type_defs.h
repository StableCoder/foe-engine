...
enum foeResourceStructureType {
    FOE_RESOURCE_STRUCTURE_TYPE_ARMATURE = FOE_RESOURCE_FUNCTIONALITY_ID,
    FOE_RESOURCE_STRUCTURE_TYPE_ARMATURE_POOL,
    FOE_RESOURCE_STRUCTURE_TYPE_ARMATURE_LOADER,
};
