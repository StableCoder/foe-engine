...
foeFragmentDescriptor::SubResources::~SubResources() { reset(); }

foeFragmentDescriptor::SubResources::SubResources(SubResources &&other) :
    pFragmentShader{std::move(other.pFragmentShader)} {
    other.pFragmentShader = nullptr;
}

auto foeFragmentDescriptor::SubResources::operator=(SubResources &&other) -> SubResources & {
    reset();
...
void foeFragmentDescriptor::SubResources::reset() {
