...
FOE_ECS_EXPORT
foeResultSet foeEcsCreateNameMap(foeEcsNameMap *pNameMap);

FOE_ECS_EXPORT
void foeEcsDestroyNameMap(foeEcsNameMap nameMap);

FOE_ECS_EXPORT
foeResultSet foeEcsNameMapFindID(foeEcsNameMap nameMap, char const *pName, foeId *pID);

FOE_ECS_EXPORT
foeResultSet foeEcsNameMapFindName(foeEcsNameMap nameMap,
                                   foeId id,
                                   uint32_t *pNameLength,
                                   char *pName);

FOE_ECS_EXPORT
foeResultSet foeEcsNameMapAdd(foeEcsNameMap nameMap, foeId id, char const *pName);

FOE_ECS_EXPORT
foeResultSet foeEcsNameMapUpdate(foeEcsNameMap nameMap, foeId id, char const *pName);

FOE_ECS_EXPORT
foeResultSet foeEcsNameMapRemove(foeEcsNameMap nameMap, foeId id);
