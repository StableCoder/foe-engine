...
FOE_ECS_EXPORT foeResultSet foeEcsComponentPoolMaintenance(foeEcsComponentPool componentPool);

FOE_ECS_EXPORT void foeEcsComponentPoolExpansionRate(foeEcsComponentPool componentPool,
                                                     size_t expansionRate);

FOE_ECS_EXPORT size_t foeEcsComponentPoolSize(foeEcsComponentPool componentPool);

FOE_ECS_EXPORT foeEntityID const *foeEcsComponentPoolIdPtr(foeEcsComponentPool componentPool);

FOE_ECS_EXPORT void *foeEcsComponentPoolDataPtr(foeEcsComponentPool componentPool);

FOE_ECS_EXPORT size_t foeEcsComponentPoolCapacity(foeEcsComponentPool componentPool);

FOE_ECS_EXPORT void foeEcsComponentPoolReserve(foeEcsComponentPool componentPool, size_t capacity);

FOE_ECS_EXPORT size_t foeEcsComponentPoolInsertCapacity(foeEcsComponentPool componentPool);

FOE_ECS_EXPORT void foeEcsComponentPoolReserveInsertCapacity(foeEcsComponentPool componentPool,
                                                             size_t capacity);
...
FOE_ECS_EXPORT size_t const *foeEcsComponentPoolInsertedOffsetPtr(
...
FOE_ECS_EXPORT foeEntityID const *foeEcsComponentPoolRemovedIdPtr(
    foeEcsComponentPool componentPool);
