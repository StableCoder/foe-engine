...
class foeEcsIndexGenerator {
  public:
     ...
     */
    FOE_ECS_EXPORT foeEcsIndexGenerator(std::string_view name, foeGroupID groupId);
     ...
     */
    FOE_ECS_EXPORT bool free(foeEntityID entity);
     ...
     */
    FOE_ECS_EXPORT bool free(uint32_t count, foeEntityID *pEntities);
     ...
     */
    FOE_ECS_EXPORT foeGroupID groupID() const noexcept;
     ...
     */
    FOE_ECS_EXPORT foeIndexID peekNextFreshIndex() const noexcept;
     ...
     */
    FOE_ECS_EXPORT void importState(foeIndexID nextIndex,
                                    std::vector<foeIndexID> const &recycledIndices);
     ...
     * @warning Overwrites the current state of the object
     */
    FOE_ECS_EXPORT void exportState(foeIndexID &nextIndex,
