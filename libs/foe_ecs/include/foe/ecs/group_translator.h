...
FOE_ECS_EXPORT
foeResultSet foeEcsCreateGroupTranslator(uint32_t originalCount,
...
FOE_ECS_EXPORT
void foeEcsDestroyGroupTranslator(foeEcsGroupTranslator groupTranslator);

FOE_ECS_EXPORT
foeResultSet foeEcsGetTranslatedGroup(foeEcsGroupTranslator groupTranslator,
                                      foeIdGroup originalGroup,
                                      foeIdGroup *pTranslatedGroup);

FOE_ECS_EXPORT
foeResultSet foeEcsGetOriginalGroup(foeEcsGroupTranslator groupTranslator,
